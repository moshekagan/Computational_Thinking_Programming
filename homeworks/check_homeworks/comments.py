WRONG_ZIP_FILE_FORMAT = " [%s] Wrong zip file format (should be like: EX#_FirsName_LastName_ID.zip)"
...
CONST_IS_NOT_CAMELCASE = " -2 Const should be written in CAPITAL_LETTERS"
